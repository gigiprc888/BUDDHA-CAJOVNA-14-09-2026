...
function Home() {
  ...
  const taste = [
    ...
    {
      img: "/shop/waysa.jpg?v=fill",
      name: t("taste.waysa"),
      t: t("taste.waysaT"),
      to: "/wayusa",
      ext: null,
      fit: "object-cover bg-white",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-bg font-sans text-fg">
      ...
      <section className="relative isolate min-h-screen overflow-hidden">
        ...
        />
        <TeaSteam />
        <div className="pointer-events-none absolute inset-0 z-[2] bg-gradient-to-t from-bg via-bg/45 to-bg/25" />
        <div className="pointer-events-none absolute inset-0 z-[2] bg-gradient-to-r from-bg/50 via-transparent to-bg/20" />
      ...
      <section id="ochutnej" className="bg-paper px-5 py-7 text-paper-ink md:px-12 md:py-8">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          {taste.map((p) => {
            const body = (
              <>
                <div className={"h-[4.75rem] w-[5.5rem] shrink-0 overflow-hidden rounded-md sm:h-20 sm:w-24 " + (p.fit.includes("bg-white") ? "bg-white" : "bg-[#efe6d4]")}>
      ...
      <section id="dymka" className="grid items-center gap-8 px-5 py-10 md:grid-cols-[minmax(16rem,24rem)_1fr] md:px-12">
        <div className="neon-pulse relative mx-auto aspect-[3/4] w-full max-w-[22rem] overflow-hidden rounded-card bg-bg">
          <LiveStill
      ...
      <section id="hry" className="grid gap-0 md:grid-cols-2">
        ...
        <div className="neon-pulse relative h-80 overflow-hidden md:min-h-[28rem]">
          <LiveStill
      ...
      <section id="gatcha" className="grid gap-0 md:grid-cols-2">
        <div className="neon-pulse relative h-72 overflow-hidden md:h-full md:min-h-[22rem]">
          <img
