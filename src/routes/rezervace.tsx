...
function Rezervace() {
  ...
  return (
    <div className="min-h-screen bg-bg font-sans text-fg">
      ...
      <main className="book-glow motif relative z-10 mx-auto grid max-w-6xl gap-10 px-5 py-10 pb-32 lg:grid-cols-[1.05fr_0.95fr] md:px-10">
        <div>
          {done ? (
        ...
        <aside className="relative z-20 hidden space-y-4 lg:sticky lg:top-24 lg:block lg:self-start">
          {roomMeta && (
